    ...
    describe.only(`Test game: ${name} - ${i}`, function() {
        ...
        it('check correct accrual fsWin', function() {
            ...
            if (actionNow === "freespin") {
                if (allWinLines !== null || (invertMatrix !== null)) {
                    ...
                    expect(fsWin).to.be.equal(oldFsWin + totalWin);
                } else {
                ...
                winLinesWithoutScatter.forEach((el) => {
                    ...
                    winPositions.forEach((el) => {
                        ...
                        if (tempSymbols !== "1") {
                            ...
                            expect("1").to.be.equal(tempSymbols);
                        }
                    });
                });
            }
        ...
        it('check total amount ESymbol is correct', () => {
            ...
            if (invertMatrix !== null) {
                ...
                expect(rightTotalAmount).to.be.equal(res.context.expendingWin.win.total);
            }
        });
        ...
        it('check correct accrual Scatter in FS', function() {
            ...
            if (res.context.hasOwnProperty("freespins") && isWinScatter == true) {
                if (total !== 10) {
                    logger.info('check correct accrual Scatter in FS');
        ...
        it('check correct accrual Scatter', function() {
            ...
            if (allWinLines !== null && isWinScatter == true && actionNow === "spin") {
                ...
                const winRightNull = PaytableCoef(winPositions, paytable10LinesBook, symbol) * bet;
